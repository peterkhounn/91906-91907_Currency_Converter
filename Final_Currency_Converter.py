...
class Converter():
    ...
    def __init__(self):
        ...
        button_details = [
            ...
            ["Help / Info", "#CC6600", self.to_help, 0, 1],
            ["History / Export", "#004C99", self.to_history, 1, 0],
            ["Clear", "#666666", self.to_clear, 1, 1]
        ]
...
class DisplayHelp:
    def __init__(self, partner):
        ...
        help_text = ("Choose your currency pair from the dropdown, "
                     ...
                     "DISCLAIMER: Exchange rates were collected on "
                     "the 24th of March 2026. Exchange rates may have "
                     "fluctuated as of the present date.")
...
class HistoryExport:
    def __init__(self, partner, calculations):
        ...
        # Export Button
        self.export_button = Button(self.history_box, text="Export to File",
                                    command=lambda: self.export_history(calculations))
        self.export_button.pack(pady=5)

        Button(self.history_box, text="Close", command=partial(self.close_history, partner)).pack(pady=10)

    def export_history(self, calculations):
        # Get current date
        today = date.today()
        ...
        with open(write_to, "w") as text_file:
            text_file.write("**** Currency Converter Calculations ****\n")
